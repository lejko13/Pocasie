...
console.log(dokument);
    ...
    const dataDnes = async () => {
        ...
        const data = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${informacie.lat}&lon=${informacie.lon}&appid=${api}`)
    ...
    const dataVsetko = async () => {
        ...
        const data = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${informacie.lat}&lon=${informacie.lon}&appid=${api}`)
